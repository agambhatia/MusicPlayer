...
let cell = tableView.dequeueReusableCell(withIdentifier: "AllSongsTableViewController", for: indexPath)
        
    
        cell.textLabel?.text = LibraryManager.shared.songs[indexPath.row].title
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        MusicPlayer.shared.play(song: LibraryManager.shared.songs[indexPath.row])
    }
