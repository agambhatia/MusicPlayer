...
class AllArtistsTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return LibraryManager.shared.artist.count
    }

    
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "AllArtistsTableViewController", for: indexPath)
        
        cell.textLabel?.text = LibraryManager.shared.artist[indexPath.row].name
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        artistSelected = indexPath.row
       performSegue(withIdentifier: "songsFromArtists", sender: self)
    }
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        let destinationViewController = segue.destination as! SongsFromCollection
        destinationViewController.artistSelected = artistSelected
    }
